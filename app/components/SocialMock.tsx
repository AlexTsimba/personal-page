...
export default function SocialMock() {
  return (
    <div className="mb-4 flex items-center justify-around rounded-lg  bg-foreground/10 py-3">
      <SocialLink href="https://www.linkedin.com/" title="Linkedin">
        <Linkedin className="text-foreground " size={30} />
      </SocialLink>

      <SocialLink href="https://www.github.com/" title="Github">
        <GitHub className="text-foreground" size={30} />
      </SocialLink>

      <SocialLink href="https://www.telegram.com/" title="Chat">
        <MessageSquare className="text-foreground" size={30} />
      </SocialLink>
      ...
      <SocialLink
        ...
        title="Email"
      >
        <Mail className="text-foreground" size={30} />
      </SocialLink>
    </div>
  );
}
